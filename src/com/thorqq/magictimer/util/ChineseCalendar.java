 ...
 * <br>
 * <i>农历算法来源于<a
 * href="http://www.herongyang.com/year_gb/program.html">和荣笔记</a>。</i>
 * 
...
public final class ChineseCalendar extends GregorianCalendar
{
    ...
    private boolean mlastSetChinese; // 最后设置的是不是农历属性
...
//    public void completeChineseOperator()
//    {
//        computeGregorianFields();
//        super.complete();
//    }
//
//    public void completeGregorianOperator()
//    {
//        super.complete();
...
//    }    
    ...
    public void set(int field, int value)
    {
        ...
        if (isChineseField(field))
        {
            ...
            mlastSetChinese = true;
        }
        else
        {
            // 非农历属性
            super.set(field, value);
            mlastSetChinese = false;
        }
        areFieldsSet = false;
    ...
    {
        //thorqq：随便get一个属性，让父类内部重新计算一下相应的值
        computeIfNeed(YEAR);
    ...
    public void add(int field, int amount)
    {
        ...
        if(amount < 0)
        {
            throw new IllegalArgumentException("不支持的amount：" + amount);
        }
    ...
    public String toString()
    {
        ...
        buf.append(getSimpleGregorianDateString()).append(" | ")
                .append(Util.dateToStr(super.getTime())).append(" | ")
    ...
    private void computeIfNeed(int field)
    {
        if (isChineseField(field))
        {
            if (!mlastSetChinese && !areChineseFieldsComputed)
            {
                super.complete();
                computeChineseFields();
                areFieldsSet = true;
        ...
        {
            if (mlastSetChinese && !areFieldsSet)
            {
                computeGregorianFields();
                super.complete();
                areFieldsSet = true;
    ...
    { ,
